...
SECRET_KEY = '1$#-95zvn8*x@n5uqto*z65+r)oe+8h)@&(!*h6+$_o9b_6pql'
...
STATICFILES_DIRS = (
    ...
    ('verify_code', os.path.join(STATIC_ROOT, 'verify_code').replace('\\', '/')),
    ('pages', os.path.join(STATIC_ROOT, 'pages').replace('\\', '/')),
)
