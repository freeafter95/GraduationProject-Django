...
class Djbasicnatu(models.Model):
    ...
    wG_VRH = models.CharField(max_length=255, null=True)
    wG_Voigt = models.CharField(max_length=255, null=True)
    wK_Ress = models.CharField(max_length=255, null=True)
    wK_VRH = models.CharField(max_length=255, null=True)
    wK_Voigt = models.CharField(max_length=255, null=True)
    mater_cate = models.CharField(max_length=255, null=True)
    brittle_tough = models.CharField(max_length=255, null=True)
    crystal_other1 = models.CharField(max_length=255, null=True)
    crystal_other2 = models.CharField(max_length=255, null=True)
    crystal_other3 = models.CharField(max_length=255, null=True)
