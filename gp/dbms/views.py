...
input_lists = {
    ...
    'process_list': {
        ...
        'second_elem': '次元素及含量',
        'trace_elem': '微量元素及含量',
        'smelting_voltage': '熔炼电压(V)',
        'qProcessing_sample': '加工前试样',
        'process_tech': '加工工艺',
        'qSample_size': '加工前试样尺寸',
        'qsyx_com': '加工前试样组成',
        'heat_temp': '加热温度(℃)',
        'qsyjld': '加工前试样晶粒度(μm)',
        'qsyzg': '加工前试样织构',
        'smelting_vacuum': '熔炼真空度(Pa)',
        'smelting_current': '熔炼电流(kA)',
        'smelting_times': '熔炼次数(次)',
        'ingot_diameter': '铸锭直径(mm)',
        'nominal_ability': '公称能力(MN)',
        'extruder_tonnage': '挤压机吨位(t)',
        'jyt_diameter': '挤压筒直径(mm)',
        'jy_heattemp': '挤压加热温度(℃)',
        'jy_bwtime': '挤压保温时间(min)',
        'bw_time': '保温时间(min)',
        'yz_jjrtime': '轧制加热温度(℃)',
        'yz_bwtime': '轧制保温时间(min)',
        'dc_maxprorate': '道次最大加工率(%)',
        'all_prorate': '总加工率(%)',
        'quenching_medium': '淬火介质()',
        'quenching_temp': '淬火温度(℃)',
        'hProcessing_sample': '加工后试样',
        'annealing_type': '退火种类',
        'annealing_temp': '退火温度(℃)',
        'annealing_temp': '退火时间',
        'hSample_size': '加工后试样尺寸',
        'hsyx_com': '加工后试样组成',
        'hsyjld': '加工后试样晶粒度',
        'hsyzg': '加工后试样织构'
    }
